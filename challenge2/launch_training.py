...
def start_training(model_name="CNN", model_params=None, training_params=None, device=None, train_loader=None, val_loader=None, data_input_shape=None, debug_mode=False, local_data_path=None):
    """
    Args:
    ...
    if model_name == "CNNCustom":
        ...
        current_model_cfg = config.RESNET_CUSTOM_DEFAULTS.copy()
    elif model_name == "HistologyResNet":
